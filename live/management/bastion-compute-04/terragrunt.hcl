...
inputs = {
  ...
  subnet_ocids        = [dependency.network.outputs.subnet_id["public_subnet"]]
  display_name     = join("-", [local.common.customer_name, local.env.environment_name, "bastion"])
